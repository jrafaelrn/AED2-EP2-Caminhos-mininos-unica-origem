...
public class Simulacao {
	...
	private void simulaTudo() throws IOException {
		...
		gerarDigrafo();
		// System.out.println("\n********** DIGRAFOS ARBITRARIOS Tamanho: " +
		// (numVertices + digrafo.getNumArcos()));
	...
	private void simulaDijkstra(int vInicial, String tipo) {
		...
		String log = "ALGORITMO:DIJKSTRA;TIPO:" + tipo + ";TAMANHO:" + tamanho + ";DENSIDADE:" + probabilidade
				+ ";TEMPO:" + tempoClock;
	...
	private void simulaBellmanFord(int vInicial, String tipo) {
		...
		String log = "ALGORITMO:BELLMAN-FORD;TIPO:" + tipo + ";TAMANHO:" + tamanho + ";DENSIDADE:" + probabilidade
				+ ";TEMPO:" + tempoClock;
		gravarArquivoLog(log);
	...
	private void simulaDagMin(int vInicial, String tipo) {
		...
		String log = "ALGORITMO:DAG-MIN;TIPO:" + tipo + ";TAMANHO:" + tamanho + ";DENSIDADE:" + probabilidade
				+ ";TEMPO:" + tempoClock;
		gravarArquivoLog(log);
	...
	static int getNumeroVertices_Digrafo(int tamanhoEntrada, double probabilidade) {
		...
		double num = (probabilidade - 1)
				+ Math.sqrt((Math.pow((1 - probabilidade), 2) + 4 * probabilidade * tamanhoEntrada))
						/ (2 * probabilidade);
	...
	static int getNumeroVertices_Dag(int tamanhoEntrada, double probabilidade) {
		...
		double num = (int) Math.round(((probabilidade / 2 - 1)
				+ Math.sqrt(Math.pow((1 - probabilidade / 2), 2) + 4 * probabilidade / 2 * tamanhoEntrada))
				/ (2 * probabilidade / 2));
		return (int) Math.round(num);
